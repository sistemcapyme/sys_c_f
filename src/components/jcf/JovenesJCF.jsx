                  ...
                  {jovenesFiltrados.length > 0 ? (
                      ...
                      return (
                        ...
                        >
                          <td style={{ padding: '14px 24px' }}>
                            <p style={{ fontSize: '13px', fontWeight: 600, color: 'var(--gray-800)', fontFamily: "'DM Sans', sans-serif", marginBottom: '4px', margin: 0 }}>
                    ...
                    <tr>
                      <td colSpan="5" style={{ padding: '60px 24px', textAlign: 'center' }}>
                        ...
                        <p style={{ fontSize: '14px', color: 'var(--gray-400)', fontWeight: 500, margin: 0 }}>No se encontraron registros</p>
                      </td>
                    </tr>
                  )}
                </tbody>
