...
const Navbar = ({ onMenuClick }) => {
  ...
  const navbarRestringido = user?.rol === 'lider_jcf' || user?.rol === 'encargado_jcf';

  const roleName  = { admin: 'Administrador', colaborador: 'Colaborador', cliente: 'Cliente', lider_jcf: 'Líder JCF', encargado_jcf: 'Encargado JCF' };
  const roleBg    = { admin: '#FEE2E2', colaborador: '#DBEAFE', cliente: '#D1FAE5', lider_jcf: '#EDE9FE', encargado_jcf: '#FEF3C7' };
  const roleColor = { admin: '#B91C1C', colaborador: '#1D4ED8', cliente: '#065F46', lider_jcf: '#6D28D9', encargado_jcf: '#B45309' };
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
          ...
          {navbarRestringido ? (
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginLeft: '2px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '6px 10px 6px 6px', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border)' }}>
              ...
              <button
                onClick={logout}
                style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 16px', background: '#FEF2F2', color: '#DC2626', border: '1px solid #FECACA', borderRadius: 'var(--radius-md)', fontWeight: 700, fontSize: '13px', cursor: 'pointer', transition: 'background 150ms ease', fontFamily: "'Plus Jakarta Sans', sans-serif" }}
