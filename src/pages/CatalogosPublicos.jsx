    ...
    <Layout>
      <div className="py-8 px-4 max-w-7xl mx-auto font-sans min-h-[80vh]">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-display font-black text-capyme-dark mb-4 tracking-tight">
            Catálogo de <span className="text-capyme-blue">PDFs</span>
          </h1>
        ...
        {loading ? (
           <div className="flex flex-col items-center justify-center py-20 gap-4">
             <div className="w-10 h-10 border-4 border-capyme-blue-pale border-t-capyme-blue rounded-full animate-spin"></div>
            ...
            {pdfs.map((pdf) => (
              <div key={pdf.id} className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 flex flex-col justify-between group overflow-hidden">
                <div className="p-6 md:p-8 flex-grow">
                  <div className="w-12 h-12 bg-capyme-blue-pale text-capyme-blue rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                    <FileText size={24} />
                  </div>
                  <h3 className="text-xl font-display font-bold text-capyme-dark mb-3 line-clamp-2 leading-tight">
                    {pdf.titulo}
                  </h3>
                  ...
                  <div className="mt-auto">
                    ...
                    <div className="text-3xl font-display font-black text-capyme-blue">
                ...
                <div className="p-4 md:p-6 bg-gray-50/80 border-t border-gray-50">
                  <button 
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-white text-capyme-blue border border-capyme-blue/20 font-bold py-3 px-4 rounded-xl hover:bg-capyme-blue hover:text-white transition-all shadow-sm"
                  >
          ...
          <div className="text-center py-20 bg-white rounded-3xl shadow-sm border border-gray-100 max-w-3xl mx-auto">
            <BookOpen size={48} className="mx-auto text-capyme-blue-pale mb-4" />
            <h3 className="text-xl font-display font-bold text-capyme-dark mb-2">Próximamente nuevos catálogos</h3>
        ...
        {selectedPdf && (
          <div className="fixed inset-0 bg-capyme-dark/60 backdrop-blur-sm flex items-center justify-center z-[100] p-4 transition-opacity">
            <div className="bg-white rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
              ...
              <div className="p-6 md:p-8 overflow-y-auto">
                <div className="flex items-start gap-4 mb-6">
                  <div className="w-14 h-14 bg-capyme-blue-pale text-capyme-blue rounded-2xl flex items-center justify-center flex-shrink-0">
                    <FileText size={28} />
                  </div>
                  <h2 className="text-2xl font-display font-extrabold text-capyme-dark leading-tight pt-1">
                    {selectedPdf.titulo}
                  </h2>
                </div>
                
                <div className="bg-capyme-blue-pale/50 p-5 rounded-2xl mb-8 border border-capyme-blue-pale">
                  <h4 className="text-xs font-bold text-capyme-blue uppercase tracking-wider mb-2">Acerca de este material</h4>
                ...
                <div className="flex justify-between items-end mb-8 p-5 bg-gray-50 rounded-2xl border border-gray-100">
                  <div>
                    ...
                    <span className="text-4xl font-display font-black text-capyme-blue">
